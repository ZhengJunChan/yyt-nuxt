...
// router.post('/v2/api/user/explogin', (req, res) => { // 收到express服务请求，进行如下处理
//   if (req.body.token) {
//     req.session.yytUser = { authStatus: req.body.authStatus, id: req.body.id, loginName: req.body.loginName, token: req.body.token }
